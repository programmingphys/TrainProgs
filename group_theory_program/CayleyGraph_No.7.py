        ...
        for j in group:
            ...
            if num == len(j):
                if N < num:
                    N = num
                    l = i+1
    cord[element.index('e')] = (w/2.3+r*math.sin(math.pi/N),h/1.8+r*math.cos(math.pi/N))
    s = generator[l]
    for i in range(N-1):
...
Caylay(generator1,group1,element1,table1)
Caylay(generator2,group2,element2,table2)